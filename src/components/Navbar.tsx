	...
	return (
		<div className='md:px-[50px] px-4 md:h-[100px] h-[60px] flex flex-row items-center justify-between'>
			...
			<div className="text-color-text md:flex items-center justify-between flex-row gap-x-12">
				<a href="#about" className=' hover:text-emerald-600 hidden md:flex'> <span className="text-emerald-400 mr-[2px]"></span> About</a>
				<a href="#work" className=' hover:text-emerald-600 hidden md:flex'><span className="text-emerald-400 mr-[2px]"></span> Work</a>
				<a href="#contact" className=' hover:text-emerald-600 hidden md:flex'><span className="text-emerald-400 mr-[2px]"></span> Contact</a>
