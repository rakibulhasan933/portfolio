		...
		<section id='about' className='py-8 px-10'>
			...
			<div className=" flex flex-row gap-x-3 text-gray-300">
				<div className="basis-2/3 pr-2 gap-y-3">
					<h2 className=' text-gray-300 pb-[2px] text-[24px] leading-loose'><span className='mr-1  font-medium text-color-sub'>Rakibul Hasan</span>| Full-Stack Web Developer</h2>
